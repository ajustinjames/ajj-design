...
describe('gl-checkbox', () => {
  it('defaults checked to false', async () => {
    const el = await fixture<DsCheckbox>(html`
      <gl-checkbox><input type="checkbox" /><label>Option</label></gl-checkbox>
    `);
  ...
  it('reflects checked from slotted native on connect', async () => {
    const el = await fixture<DsCheckbox>(html`
      <gl-checkbox><input type="checkbox" checked /><label>Option</label></gl-checkbox>
    `);
  ...
  it('updates checked on native change event', async () => {
    const el = await fixture<DsCheckbox>(html`
      <gl-checkbox><input id="cb" type="checkbox" /><label>Option</label></gl-checkbox>
    `);
  ...
  it('defaults disabled to false', async () => {
    const el = await fixture<DsCheckbox>(html`
      <gl-checkbox><input type="checkbox" /></gl-checkbox>
    `);
