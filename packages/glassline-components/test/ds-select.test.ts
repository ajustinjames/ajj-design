...
describe('gl-select', () => {
  it('defaults state to default', async () => {
    const el = await fixture<DsSelect>(html`
      <gl-select><select><option>A</option></select></gl-select>
    `);
  ...
  it('reflects state attribute', async () => {
    const el = await fixture<DsSelect>(html`
      <gl-select state="error"><select><option>A</option></select></gl-select>
    `);
  ...
  it('renders slotted select', async () => {
    const el = await fixture<DsSelect>(html`
      <gl-select><select id="inner"><option>A</option></select></gl-select>
    `);
