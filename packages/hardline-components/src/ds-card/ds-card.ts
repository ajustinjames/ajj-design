...
export class DsCard extends LitElement {
  static styles = css`
    :host {
      ...
      border: var(--hl-card-border-width, var(--hl-alias-surface-border-width, 1px)) solid var(--hl-card-border-color, var(--hl-alias-surface-border, #1A1A1A));
      padding: var(--hl-card-padding, var(--hl-alias-surface-padding, 24px));
      border-radius: var(--hl-card-radius, var(--hl-alias-radius-default, 0px));
