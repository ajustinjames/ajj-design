...
describe('hl-select', () => {
  it('defaults state to default', async () => {
    const el = await fixture<DsSelect>(html`
      <hl-select><select><option>A</option></select></hl-select>
    `);
  ...
  it('reflects state attribute', async () => {
    const el = await fixture<DsSelect>(html`
      <hl-select state="error"><select><option>A</option></select></hl-select>
    `);
  ...
  it('renders slotted select', async () => {
    const el = await fixture<DsSelect>(html`
      <hl-select><select id="inner"><option>A</option></select></hl-select>
    `);
