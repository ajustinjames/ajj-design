...
describe('hl-input', () => {
  it('has display: flex', async () => {
    const el = await fixture<DsInput>(html`
      <hl-input><input type="text" /></hl-input>
    `);
  ...
  it('reflects state attribute', async () => {
    const el = await fixture<DsInput>(html`
      <hl-input state="error"><input type="text" /></hl-input>
    `);
  ...
  it('reflects density="compact" attribute', async () => {
    const el = await fixture<DsInput>(html`
      <hl-input density="compact"><input type="text" /></hl-input>
    `);
  ...
  it('reflects data-type="clinical" attribute', async () => {
    const el = await fixture<DsInput>(html`
      <hl-input data-type="clinical"><input type="text" /></hl-input>
    `);
  ...
  it('renders slotted input in default slot', async () => {
    const el = await fixture<DsInput>(html`
      <hl-input><input id="native" type="text" /></hl-input>
    `);
  ...
  it('idle background resolves to surface-bg-alt (#F0F0EC fallback)', async () => {
    const el = await fixture<DsInput>(html`<hl-input><input type="text" /></hl-input>`);
  ...
  it('emits dev warning when label present but no association', async () => {
    ...
    console.warn = orig;
    expect(warnings.some(w => w.includes('hl-input'))).to.be.true;
  });

  it('disabled prop reflects attribute', async () => {
    const el = await fixture<DsInput>(html`<hl-input disabled><input type="text" disabled /></hl-input>`);
